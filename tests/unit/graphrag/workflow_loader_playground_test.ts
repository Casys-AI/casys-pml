...
Deno.test("Playground Templates - File exists and is readable", async () => {
...
Deno.test("Playground Templates - Valid YAML syntax", async () => {
  const content = await Deno.readTextFile(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #1: Contains 3+ workflows", async () => {
...
Deno.test("Playground Templates - AC #1: Parallel execution pattern exists", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #1: Sequential pattern exists (filesystem → memory)", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #1: Multi-level DAG exists", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #2: Format compatible with WorkflowLoader", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #2: Each workflow has required fields", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #2: Tool IDs use correct format (serverId:toolName)", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #2: Tool IDs reference configured MCP servers", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - AC #3: File contains explanatory comments", async () => {
  const content = await Deno.readTextFile(PLAYGROUND_TEMPLATES_PATH);
...
Deno.test("Playground Templates - Edge conversion produces correct structure", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
  const edges = loader.convertToEdges(workflows);
...
Deno.test("Playground Templates - Workflow names are unique", async () => {
  const loader = new WorkflowLoader();
  const workflows = await loader.loadFromYaml(PLAYGROUND_TEMPLATES_PATH);
