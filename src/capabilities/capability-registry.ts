...
export interface CreateCapabilityRecordInput {
  ...
  hash: string;
  /** User ID (UUID FK to users table, null for local/system records) */
  userId?: string;
  /** Optional tags */
  tags?: string[];
...
export class CapabilityRegistry {
  ...
  async create(input: CreateCapabilityRecordInput): Promise<CapabilityRecord> {
    ...
    // Migration 039: user_id is UUID FK to users (replaces old TEXT created_by)
  ...
  private rowToRecord(row: Record<string, unknown>): CapabilityRecord {
    ...
    return {
      ...
      // Migration 039: user_id UUID FK replaces TEXT created_by
