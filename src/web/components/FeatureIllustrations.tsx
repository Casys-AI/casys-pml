    ...
    <svg width="100%" height="100%" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(200 150)">
        ...
        <path d="M0 -30 L 40 -10 V 30 L 0 50 L -40 30 V -10 Z" 
              fill="#141418" stroke="#FFB86F" stroke-width="3" />
  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(130, 220)">
        <rect x="-30" y="-15" width="60" height="30" rx="6" fill="#141418" stroke="#4ade80" stroke-width="2" />
      ...
      <g transform="translate(270, 220)">
        <rect x="-30" y="-15" width="60" height="30" rx="6" fill="#141418" stroke="#f87171" stroke-width="2" />
    ...
    <svg width="100%" height="100%" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <pattern id="hex-grid" width="20" height="34.64" patternUnits="userSpaceOnUse">
           <path d="M10 0 L20 8.66 V25.98 L10 34.64 L0 25.98 V8.66 Z" fill="none" stroke="#FFB86F" stroke-width="0.5" opacity="0.05"/>
        </pattern>
      ...
      <g transform="translate(80 20)">
         <rect x="0" y="0" width="240" height="50" rx="4" fill="url(#rack-grad)" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.6" />
         
         {/* Icon: Brain Core */}
         <g transform="translate(30 25)">
            <circle r="15" fill="url(#core-glow)" />
            <circle r="8" fill="#141418" stroke="#FFB86F" stroke-width="1.5" />
            <path d="M-6 -3 L 0 -8 L 6 -3 L 6 4 L 0 8 L -6 4 Z" stroke="#FFB86F" stroke-width="1" fill="none"/>
            <circle r="1.5" fill="#fff">
               <animateMotion dur="3s" repeatCount="indefinite" path="M0 0 m-10 0 a 10 10 0 1 0 20 0 a 10 10 0 1 0 -20 0" />
            </circle>
         </g>
         
         <text x="60" y="30" fill="#FFB86F" font-size="10" font-family="monospace" font-weight="bold" letter-spacing="2">CAPABILITIES</text>
         <text x="230" y="30" text-anchor="end" fill="#d5c3b5" font-size="8" font-family="monospace" opacity="0.7">CONTEXT</text>
      ...
      <line x1="200" y1="70" x2="200" y2="90" stroke="#FFB86F" stroke-width="2" marker-end="url(#arrow-down)" opacity="0.5"/>
      ...
      <g transform="translate(80 90)">
         ...
         {/* Icon: Matrix */}
         <g transform="translate(30 25)">
            <rect x="-10" y="-10" width="20" height="20" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.5"/>
            <circle cx="-10" cy="-10" r="2" fill="#FFB86F"/>
            <circle cx="10" cy="10" r="2" fill="#FFB86F"/>
            <path d="M-10 -10 L 10 10" stroke="#FFB86F" stroke-width="1"/>
         </g>
         
         <text x="60" y="30" fill="#FFB86F" font-size="10" font-family="monospace" font-weight="bold" letter-spacing="2">PATTERNS</text>
         <text x="230" y="30" text-anchor="end" fill="#d5c3b5" font-size="8" font-family="monospace" opacity="0.7">RULES</text>
         
         <circle cx="230" cy="10" r="2" fill="#FFB86F" opacity="0.8"/>
      </g>

      {/* Forward Flow Arrow 2 */}
      <line x1="200" y1="140" x2="200" y2="160" stroke="#FFB86F" stroke-width="2" marker-end="url(#arrow-down)" opacity="0.5"/>
      <circle r="2" fill="#FFB86F">
      ...
      <g transform="translate(80 160)">
         ...
         <text x="60" y="30" fill="#FFB86F" font-size="10" font-family="monospace" font-weight="bold" letter-spacing="2">DAG</text>
         <text x="230" y="30" text-anchor="end" fill="#d5c3b5" font-size="8" font-family="monospace" opacity="0.7">PLAN</text>
         
         <circle cx="230" cy="10" r="2" fill="#FFB86F" opacity="0.8"/>
      </g>

      {/* Forward Flow Arrow 3 */}
      <line x1="200" y1="210" x2="200" y2="230" stroke="#FFB86F" stroke-width="2" marker-end="url(#arrow-down)" opacity="0.5"/>
      <circle r="2" fill="#FFB86F">
      ...
      <g transform="translate(80 230)">
         ...
         <g transform="translate(30 25)">
            ...
            <text x="-8" y="4" fill="#FFB86F" font-size="8" font-family="monospace" font-weight="bold">&gt;_</text>
         </g>
         
         <text x="60" y="30" fill="#FFB86F" font-size="10" font-family="monospace" font-weight="bold" letter-spacing="2">EXECUTION</text>
         <text x="230" y="30" text-anchor="end" fill="#d5c3b5" font-size="8" font-family="monospace" opacity="0.7">ACTION</text>
      ...
      <path d="M320 255 L 340 255 L 340 185 L 320 185" stroke="#FFB86F" stroke-width="1.5" stroke-dasharray="4 2" fill="none" opacity="0.6" marker-end="url(#arrow-up)"/>
      <text x="345" y="225" fill="#FFB86F" font-size="7" font-family="monospace" opacity="0.6" transform="rotate(90 345 225)">ADAPTATION</text>
      <circle r="2" fill="#FFB86F">
         <animateMotion dur="3s" repeatCount="indefinite" path="M320 255 L 340 255 L 340 185 L 320 185" />
      </circle>

      {/* Loop 2: Execution -> Patterns (Adaptation) */}
      <path d="M320 255 L 360 255 L 360 115 L 320 115" stroke="#FFB86F" stroke-width="1.5" stroke-dasharray="4 2" fill="none" opacity="0.5" marker-end="url(#arrow-up)"/>
      <text x="365" y="190" fill="#FFB86F" font-size="7" font-family="monospace" opacity="0.5" transform="rotate(90 365 190)">SPECULATION</text>
      <circle r="2" fill="#FFB86F">
         <animateMotion dur="5s" repeatCount="indefinite" path="M320 255 L 360 255 L 360 115 L 320 115" />
      </circle>

      {/* Loop 3: Execution -> Capabilities (Crystallization) */}
      <path d="M320 255 L 380 255 L 380 45 L 320 45" stroke="#FFB86F" stroke-width="1.5" stroke-dasharray="4 2" fill="none" opacity="0.4" marker-end="url(#arrow-up)"/>
      <text x="385" y="160" fill="#FFB86F" font-size="7" font-family="monospace" opacity="0.4" transform="rotate(90 385 160)">CRYSTALLIZATION</text>
      <circle r="2" fill="#FFB86F">
         <animateMotion dur="8s" repeatCount="indefinite" path="M320 255 L 380 255 L 380 45 L 320 45" />
      </circle>
    ...
    <svg width="100%" height="100%" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g stroke="#FFB86F" fill="none">
        ...
        <path d="M80 100 Q 120 80 150 110" stroke-width="1.5" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.4;0.4" dur="4s" begin="0s" fill="freeze" />
        </path>
        <path d="M150 110 Q 180 130 200 100" stroke-width="1.5" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.5;0.5" dur="4s" begin="0.5s" fill="freeze" />
        </path>
        <path d="M200 100 Q 240 90 270 120" stroke-width="1.5" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.4;0.4" dur="4s" begin="1s" fill="freeze" />
        </path>

        {/* Second wave - more connections emerge */}
        <path d="M100 180 Q 140 160 150 110" stroke-width="1" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.3;0.3" dur="4s" begin="1.5s" fill="freeze" />
        </path>
        <path d="M150 110 Q 170 150 200 180" stroke-width="1.5" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.5;0.5" dur="4s" begin="2s" fill="freeze" />
        </path>
        <path d="M200 180 Q 230 160 270 120" stroke-width="1" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.3;0.3" dur="4s" begin="2.5s" fill="freeze" />
        </path>
        <path d="M270 120 Q 300 150 320 180" stroke-width="1.5" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.4;0.4" dur="4s" begin="3s" fill="freeze" />
        </path>

        {/* Third wave - structure solidifies */}
        <path d="M80 100 Q 90 140 100 180" stroke-width="1" stroke-opacity="0" stroke-dasharray="4 2">
          <animate attributeName="stroke-opacity" values="0;0.25;0.25" dur="4s" begin="3.5s" fill="freeze" />
        </path>
        <path d="M200 100 Q 200 140 200 180" stroke-width="2" stroke-opacity="0">
          <animate attributeName="stroke-opacity" values="0;0.6;0.6" dur="4s" begin="4s" fill="freeze" />
        </path>
        <path d="M320 180 Q 290 200 250 210" stroke-width="1" stroke-opacity="0" stroke-dasharray="4 2">
          <animate attributeName="stroke-opacity" values="0;0.25;0.25" dur="4s" begin="4.5s" fill="freeze" />
        </path>
      </g>
      ...
      <g>
        ...
        <circle cx="80" cy="100" r="4" fill="#FFB86F" fill-opacity="0.8">
          ...
          <animate attributeName="fill-opacity" values="0.6;1;0.6" dur="2.3s" repeatCount="indefinite" />
        </circle>
        ...
        <circle cx="100" cy="180" r="4" fill="#FFB86F" fill-opacity="0.8">
          ...
          <animate attributeName="fill-opacity" values="0.6;1;0.6" dur="2.1s" repeatCount="indefinite" />
        </circle>

        {/* Agent 6 - Another hub forming */}
        <circle cx="200" cy="180" r="15" fill="none" stroke="#FFB86F" stroke-width="2">
          <animate attributeName="stroke-opacity" values="0.5;1;0.5" dur="1.9s" repeatCount="indefinite" />
        </circle>
        <circle cx="200" cy="180" r="5" fill="#FFB86F">
          <animate attributeName="r" values="4;7;4" dur="1.9s" repeatCount="indefinite" />
          <animate attributeName="fill-opacity" values="0.7;1;0.7" dur="1.9s" repeatCount="indefinite" />
        </circle>

        {/* Agent 7 */}
        <circle cx="320" cy="180" r="12" fill="none" stroke="#FFB86F" stroke-width="1.5">
          <animate attributeName="stroke-opacity" values="0.3;0.8;0.3" dur="2.4s" repeatCount="indefinite" />
        </circle>
        <circle cx="320" cy="180" r="4" fill="#FFB86F" fill-opacity="0.8">
          <animate attributeName="r" values="3;5;3" dur="2.4s" repeatCount="indefinite" />
          <animate attributeName="fill-opacity" values="0.6;1;0.6" dur="2.4s" repeatCount="indefinite" />
        </circle>
        ...
        <circle cx="250" cy="210" r="3" fill="#FFB86F" fill-opacity="0.6">
          <animate attributeName="fill-opacity" values="0.4;0.8;0.4" dur="2.7s" repeatCount="indefinite" />
        </circle>
      </g>

      {/* Signals traveling through emergent connections */}
      <circle r="2.5" fill="#FFB86F" filter="url(#cas-blur)">
        <animateMotion dur="3s" begin="5s" repeatCount="indefinite" path="M80 100 Q 120 80 150 110 Q 180 130 200 100 Q 240 90 270 120" />
      </circle>
      <circle r="2" fill="#FFB86F" filter="url(#cas-blur)">
        <animateMotion dur="2.5s" begin="6s" repeatCount="indefinite" path="M200 100 Q 200 140 200 180" />
      </circle>
      <circle r="2" fill="#FFB86F" filter="url(#cas-blur)">
        <animateMotion dur="3.5s" begin="5.5s" repeatCount="indefinite" path="M100 180 Q 140 160 150 110" />
      </circle>
    </svg>
  );
}
    ...
    <svg width="100%" height="100%" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        ...
        <circle r="4" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.5">
          <animateMotion dur="6s" repeatCount="indefinite" path="M60 80 Q 100 60 140 90 Q 160 110 130 130 Q 80 120 60 80" />
        </circle>
        ...
        <circle r="3" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.4">
          <animateMotion dur="5s" repeatCount="indefinite" path="M340 100 Q 300 80 280 120 Q 260 160 300 170 Q 340 150 340 100" />
        </circle>
        ...
        <circle r="3.5" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.5">
          <animateMotion dur="7s" repeatCount="indefinite" path="M80 200 Q 120 230 160 210 Q 180 180 140 170 Q 100 180 80 200" />
        </circle>
        <circle r="1.5" fill="#FFB86F" fill-opacity="0.7">
          <animateMotion dur="7s" repeatCount="indefinite" path="M80 200 Q 120 230 160 210 Q 180 180 140 170 Q 100 180 80 200" />
        </circle>
        ...
        <circle r="4" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.4">
          <animateMotion dur="5.5s" repeatCount="indefinite" path="M320 200 Q 280 220 260 190 Q 250 160 290 165 Q 330 180 320 200" />
        </circle>
        <circle r="1.5" fill="#FFB86F" fill-opacity="0.6">
          <animateMotion dur="5.5s" repeatCount="indefinite" path="M320 200 Q 280 220 260 190 Q 250 160 290 165 Q 330 180 320 200" />
        </circle>
      ...
      <g>
        ...
        <circle r="2" fill="#FFB86F">
          <animateMotion dur="3.5s" begin="0.5s" repeatCount="indefinite" path="M350 80 Q 280 110 200 150" />
          <animate attributeName="opacity" values="0.8;0.2" dur="3.5s" begin="0.5s" repeatCount="indefinite" />
          <animate attributeName="r" values="3;1" dur="3.5s" begin="0.5s" repeatCount="indefinite" />
        </circle>
        <circle r="2" fill="#FFB86F">
          <animateMotion dur="4s" begin="1s" repeatCount="indefinite" path="M50 220 Q 120 190 200 150" />
          <animate attributeName="opacity" values="0.8;0.2" dur="4s" begin="1s" repeatCount="indefinite" />
          <animate attributeName="r" values="3;1" dur="4s" begin="1s" repeatCount="indefinite" />
        </circle>
        <circle r="2" fill="#FFB86F">
          <animateMotion dur="3.8s" begin="1.5s" repeatCount="indefinite" path="M340 240 Q 270 200 200 150" />
          <animate attributeName="opacity" values="0.8;0.2" dur="3.8s" begin="1.5s" repeatCount="indefinite" />
          <animate attributeName="r" values="3;1" dur="3.8s" begin="1.5s" repeatCount="indefinite" />
        </circle>
      </g>
      ...
      <g transform="translate(200, 150)">
        {/* Glow behind crystal */}
        <polygon points="0,-45 27,-22 27,22 0,45 -27,22 -27,-22" fill="#FFB86F" fill-opacity="0.15" filter="url(#phase-blur)">
          <animate attributeName="fill-opacity" values="0.1;0.25;0.1" dur="3s" repeatCount="indefinite" />
        </polygon>

        {/* Crystal outer form */}
        <polygon points="0,-40 24,-20 24,20 0,40 -24,20 -24,-20" fill="url(#crystallize-grad)" stroke="#FFB86F" stroke-width="1.5">
          <animate attributeName="stroke-opacity" values="0.6;1;0.6" dur="2s" repeatCount="indefinite" />
        </polygon>

        {/* Crystal inner facets - showing structure */}
        <line x1="0" y1="-40" x2="0" y2="40" stroke="#FFB86F" stroke-width="0.5" stroke-opacity="0.3" />
        <line x1="-24" y1="-20" x2="24" y2="20" stroke="#FFB86F" stroke-width="0.5" stroke-opacity="0.3" />
        <line x1="-24" y1="20" x2="24" y2="-20" stroke="#FFB86F" stroke-width="0.5" stroke-opacity="0.3" />

        {/* Growing core - capability solidifying */}
        <circle r="8" fill="#FFB86F" fill-opacity="0.9">
          <animate attributeName="r" values="6;10;6" dur="2.5s" repeatCount="indefinite" />
          <animate attributeName="fill-opacity" values="0.7;1;0.7" dur="2.5s" repeatCount="indefinite" />
        </circle>

        {/* Sparkle points showing crystallization */}
        <circle cx="8" cy="-18" r="2" fill="#fff" fill-opacity="0">
          <animate attributeName="fill-opacity" values="0;0.9;0" dur="2s" begin="0s" repeatCount="indefinite" />
        </circle>
        <circle cx="-12" cy="8" r="1.5" fill="#fff" fill-opacity="0">
          <animate attributeName="fill-opacity" values="0;0.8;0" dur="2s" begin="0.7s" repeatCount="indefinite" />
        </circle>
        <circle cx="10" cy="15" r="1.5" fill="#fff" fill-opacity="0">
          <animate attributeName="fill-opacity" values="0;0.7;0" dur="2s" begin="1.3s" repeatCount="indefinite" />
        </circle>
      </g>
      ...
      <g fill="none" stroke="#FFB86F">
        ...
        <ellipse cx="200" cy="150" rx="45" ry="40" stroke-width="1" stroke-opacity="0">
          <animate attributeName="rx" values="35;70;35" dur="4s" begin="2s" repeatCount="indefinite" />
          <animate attributeName="ry" values="30;60;30" dur="4s" begin="2s" repeatCount="indefinite" />
          <animate attributeName="stroke-opacity" values="0.5;0;0.5" dur="4s" begin="2s" repeatCount="indefinite" />
        </ellipse>
      </g>
      ...
      <g>
        {/* Stable capability 1 */}
        <polygon points="60,70 72,76 72,88 60,94 48,88 48,76" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.4" />
        ...
        {/* Stable capability 2 */}
        <polygon points="340,90 352,96 352,108 340,114 328,108 328,96" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.4" />
        <circle cx="340" cy="102" r="3" fill="#FFB86F" fill-opacity="0.5">
          <animate attributeName="fill-opacity" values="0.3;0.6;0.3" dur="3.5s" repeatCount="indefinite" />
        </circle>

        {/* Stable capability 3 */}
        <polygon points="70,210 82,216 82,228 70,234 58,228 58,216" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.4" />
        <circle cx="70" cy="222" r="3" fill="#FFB86F" fill-opacity="0.5">
          <animate attributeName="fill-opacity" values="0.3;0.6;0.3" dur="2.8s" repeatCount="indefinite" />
        </circle>

        {/* Stable capability 4 */}
        <polygon points="330,200 342,206 342,218 330,224 318,218 318,206" fill="none" stroke="#FFB86F" stroke-width="1" stroke-opacity="0.4" />
        <circle cx="330" cy="212" r="3" fill="#FFB86F" fill-opacity="0.5">
          <animate attributeName="fill-opacity" values="0.3;0.6;0.3" dur="3.2s" repeatCount="indefinite" />
        </circle>
      </g>
