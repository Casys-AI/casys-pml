/**
 * EdgeLegendItem Molecule - Single legend entry with line indicator
 * Used for: Edge types and confidence legends in graph visualization
...
export default function EdgeLegendItem({
  label,
  color,
  lineStyle = "solid",
  opacity = 1,
