...
| `implemented` | Implémentation complète |
| `draft` | En cours de rédaction |
| `proposed` | Proposé, en attente de validation |
| `deprecated` | Obsolète, remplacé par autre ADR |
| `superseded` | Remplacé (voir superseded_by) |
...
### Proposed (4)
ADR-033, ADR-034, ADR-035, ADR-036, ADR-037
