...
- **Epic 9** extends: Epic 1 with dual-mode authentication (Cloud: GitHub OAuth + API Keys, Self-hosted: zero-auth)
- **Epic 10** extends: Epic 7 with unified DAG/Code learning (static analysis, DAG reconstruction, provides edges)
