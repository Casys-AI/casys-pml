...
Toutes les décisions d'architecture sont documentées dans le dossier dédié :

**→ [docs/adrs/index.md](../adrs/index.md)**
...
| Range | Domaine | Impl. |
|-------|---------|-------|
| 001-006 | Fondations (PGlite, DAG, Embeddings, Transport, Graphology, Speculation) | done |
| 007-008 | DAG Feedback Loops & Episodic Memory | done |
