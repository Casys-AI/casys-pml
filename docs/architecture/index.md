...
| Document | Changes |
|----------|---------|
| [Security Architecture](./security-architecture.md) | BYOK security, multi-tenant auth (Migration 039), rate limiting, JSON Schema validation (ajv) |
| [Deployment Architecture](./deployment-architecture.md) | JSR packages (@casys/pml v0.2.6), Alloy log collector, CI/CD pipelines |
| [Technology Stack](./technology-stack-details.md) | Deno 2.6.3, CasysDB Rust crates, @pml/shgat, ajv validation |
| [Pattern 07 - SHGAT](./patterns/07-shgat-architecture.md) | lib/shgat extraction, 16 K-heads, BLAS FFI, PER training, V→V co-occurrence |
| [Data Architecture](./data-architecture.md) | Migration 039, user FQDN format with user_id UUID |
| [ML Pipeline](./ml-pipeline-architecture.md) | lib/shgat standalone library structure |
