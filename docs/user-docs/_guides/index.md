...
Practical guides for working with PML. These guides provide hands-on examples and best practices for
common workflows.
...
A comprehensive guide covering all major features of PML. This guide walks through practical
...
- **Semantic Tool Search** - Find tools by natural intent using embeddings and GraphRAG
  - Related concepts: [Semantic Search](../concepts/02-discovery/01-semantic-search.md),
    [GraphRAG](../concepts/03-learning/01-graphrag.md)
- **DAG Workflow Execution** - Orchestrate multi-tool workflows with automatic parallelization
  ...
  - Related concepts: [DAG Structure](../concepts/05-dag-execution/01-dag-structure.md),
    [Parallelization](../concepts/05-dag-execution/03-parallelization.md)
...
- **Sandbox Code Execution** - Execute TypeScript in isolated environments with MCP tool access
  ...
  - Related concepts: [Sandbox](../concepts/06-code-execution/01-sandbox.md),
    [Worker Bridge](../concepts/06-code-execution/02-worker-bridge.md)
...
- **Observability** - Grafana/Loki monitoring, Sentry error tracking, Fresh Dashboard
  - Related concepts: [Events](../concepts/07-realtime/01-events.md),
    [Visualization](../concepts/07-realtime/02-visualization.md)
