...
**Decision (2025-12-26):** Le système de curation automatique LLM (suggestions de noms, confidence scoring, batch processing) n'est pas nécessaire pour l'instant.

Les fonctionnalités essentielles (`cap:list`, `cap:rename`) sont mergées dans **Story 13.5: Capability Management Tools**.
