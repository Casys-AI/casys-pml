...
3. L'utilisateur voulant apprendre Casys PML n'aura pas de démo des features clés actuelles
...
**Rationale:** Showcaser la valeur unique d'Casys PML vs concurrents (Docker Dynamic MCP, Anthropic PTC).
...
Le MVP Casys PML reste inchangé. Ce changement améliore la **valeur pédagogique** du playground en alignant la documentation avec les capabilities actuelles.

**Bénéfice:** Les utilisateurs découvrant Casys PML via le playground verront les innovations clés (capability learning) plutôt que seulement les fondations (DAG execution).

---

**Document généré par:** Correct-Course Workflow
**Approval Status:** ✅ Approuvé (2025-12-06)
**Changes Applied:**
- `sprint-status-playground.yaml` - Story names updated
- `epics-playground.md` - Summary and Status Detail updated
