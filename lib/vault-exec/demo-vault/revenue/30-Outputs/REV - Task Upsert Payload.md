...
inputs:
  csmDailyPlan: "{{REV - CSM Daily Plan.csmDailyPlan}}"
  accountContractLinks: "{{REV - Account Contract Links.accountContractLinks}}"
code: >-
...
Deps: [[REV - CSM Daily Plan]], [[REV - Account Contract Links]]
