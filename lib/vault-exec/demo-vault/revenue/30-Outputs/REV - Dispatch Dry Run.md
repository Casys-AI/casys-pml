...
inputs:
  dispatchBatch: "{{REV - Dispatch Batch.dispatchBatch}}"
  payloadValidation: "{{REV - Payload Validator.payloadValidation}}"
  idempotencyKeys: "{{REV - Idempotency Key Builder.idempotencyKeys}}"
code: >-
...
Deps: [[REV - Dispatch Batch]], [[REV - Payload Validator]], [[REV - Idempotency Key Builder]]
