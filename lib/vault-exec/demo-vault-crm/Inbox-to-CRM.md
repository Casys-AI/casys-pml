...
code: >-
  (() => {
    ...
    const ownerMap = { enterprise: 'alice', 'mid-market': 'bob', smb: 'charlie' };
    ...
    return {
      ...
      sender: rawSender,
      segment: seg,
      assignedOwner: ownerMap[seg] || 'charlie',
...
- Derives owner from segment (enterprise → alice, mid-market → bob, smb → charlie).
