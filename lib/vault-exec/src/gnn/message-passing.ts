 ...
 * E_MP = ELU(Sum_c alpha_pc * W_child * H_c)
 * E = (1-gamma)*E_MP + gamma*E_orig  (convex gated residual)
 */
export function vertexToEdge(
  ...
  // Concatenate heads and map to embDim via cyclic projection
 ...
 * H_MP = ELU(Sum_p alpha_cp * W_parent * E_p)
