...
- Synthetic traces set `synthetic=true`, `success=true`, and use the target note as `targetNote`.
...
- `recordTrace()` forwards execution fields as-is to `IVaultStore.insertTrace()`.
