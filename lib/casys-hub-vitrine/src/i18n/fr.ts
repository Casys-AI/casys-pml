...
export const fr: Translations = {
  ...
  whatWeDo: {
    title: "Context Engineering & Infrastructure MCP",
    subtitle: "Recherche appliquée, outils open source et consulting architecture agentique",
    cards: [
      {
        id: "research",
        icon: "school",
  ...
  blog: {
    title: "Blog : Recherche & Architecture AI",
