...
const HOSTNAME_REWRITES = [
  ...
  {
    src: '^/(?!_astro/|_vercel/|api/|ui/|icons/|fonts/|images/|pagefind/|docs/|fr/|zh/|mcp-server/)(.*)$',
    has: [{ type: 'host', value: 'mcp-server.casys.ai' }],
    dest: '/mcp-server/$1',
  },
  {
    src: '^/(?!_astro/|_vercel/|api/|ui/|icons/|fonts/|images/|pagefind/|docs/|fr/|zh/|mcp-std/)(.*)$',
    has: [{ type: 'host', value: 'mcp-std.casys.ai' }],
    dest: '/mcp-std/$1',
  },
  {
    src: '^/(?!_astro/|_vercel/|api/|ui/|icons/|fonts/|images/|pagefind/|docs/|fr/|zh/|engine/)(.*)$',
    has: [{ type: 'host', value: 'engine.casys.ai' }],
    dest: '/engine/$1',
  },
  {
    src: '^/(?!_astro/|_vercel/|api/|ui/|icons/|fonts/|images/|pagefind/|docs/|fr/|zh/|mcp-bridge/)(.*)$',
    has: [{ type: 'host', value: 'mcp-bridge.casys.ai' }],
    dest: '/mcp-bridge/$1',
  },
];
