      ...
      head: [
        {
          ...
          content: `
(function() {
  var keep = { 'engine.casys.ai': '@casys/shgat', 'mcp-server.casys.ai': '@casys/mcp-server', 'mcp-bridge.casys.ai': '@casys/mcp-bridge' };
  var titles = { 'engine.casys.ai': 'SHGAT Docs', 'mcp-server.casys.ai': 'MCP Server Docs', 'mcp-bridge.casys.ai': 'MCP Bridge Docs' };
  ...
  if (document.querySelector('.top-level')) { apply(); return; }
