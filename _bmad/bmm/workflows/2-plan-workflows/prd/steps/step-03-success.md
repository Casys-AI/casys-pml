...
success criteria and move to User Journey Mapping (Step 4 of 11)"

### 9. Handle Menu Selection

#### If 'A' (Advanced Elicitation):

- Execute {project-root}/\_bmad/core/tasks/advanced-elicitation.xml with the current success
  criteria content
...
- Execute {project-root}/\_bmad/core/workflows/party-mode/workflow.md with the current success
  criteria
