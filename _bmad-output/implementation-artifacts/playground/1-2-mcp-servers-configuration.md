...
- Workspace root: `/workspaces/Casys PML` (or similar)
...
- Workspace root accessible at `/workspaces/Casys PML` or similar
...
3. Configure Codespace workspace paths (`/workspaces/Casys PML`)
...
- Configured for Codespace environment (`/workspaces/Casys PML`) with note about local development
...
- ℹ️ Configured for Codespace path `/workspaces/Casys PML` (documentation includes local
  development notes)
